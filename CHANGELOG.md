...
- Added an Apricode gray gradient from `#818471` to `#151613` for the main IDE frame.

### Changed

- Kept the editor and tool windows at `#272822`, moved inactive tabs to `#151613`, and styled active tabs with `#36372F`.
